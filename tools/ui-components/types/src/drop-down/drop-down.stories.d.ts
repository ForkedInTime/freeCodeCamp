...
declare const story: {
    title: string;
    component: {
        ({ children, dropup, ...props }: import("./drop-down").DropdownProps): JSX.Element;
        Menu: React.ForwardRefExoticComponent<{
            ...
            as?: "button" | undefined;
            children?: React.ReactNode | ((bag: import("./drop-down").ButtonRenderPropArg) => React.ReactElement<any, string | React.JSXElementConstructor<any>>);
            refName?: string | undefined;
        } & {
            className?: string | ((bag: import("./drop-down").ButtonRenderPropArg) => string) | undefined;
        } & {
            disabled?: boolean | undefined;
        } & React.RefAttributes<HTMLDivElement>>;
        Toggle: ({ children, className, ...rest }: {
            type?: "button" | "reset" | "submit" | undefined;
            key?: React.Key | null | undefined;
            id?: string | undefined;
            name?: string | undefined;
...
export declare const Menus: StoryObj<typeof Dropdown>;
export declare const DropUp: StoryObj<typeof Dropdown>;
export default story;
//# sourceMappingURL=drop-down.stories.d.ts.map